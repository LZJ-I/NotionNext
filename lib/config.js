...
import { rewriteStaticAssetValue } from './utils/jsdMirror'
...
export const siteConfig = (key, defaultVal = null, extendConfig = {}) => {
  ...
  const convertAndRewrite = value =>
    rewriteStaticAssetValue(convertVal(value), {
      enabled: convertVal(BLOG.JSDMIRROR_ENABLE),
